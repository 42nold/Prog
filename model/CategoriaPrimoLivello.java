	...
	private int maxRisorse;
 	...
 	public CategoriaPrimoLivello(String nome, int durataMassimaPrestito, int durataMassimaProroga, int termineProroga, int maxRisorse, int id) {
		...
		assert invariante();
 		...
 		/**
 		 * verifica che le propriet� invarianti della classe siano verificate
 		 * @pre true
 		 * @post @nochange
 		 * @return true se gli attributi assumono valori validi e l'invariante della superclasse � verificata e i getters ritornano i giusti valori
 		 */
 ...
 */
	 ...
	 * @return true se c'� almeno una risorsa
	 * @pre true
	 * @post @nochange
	 */
	 ...
	 * @return true se c'� almeno una sottocategoria
	 * @pre true
	 * @post @nochange
	 */
 ...
 * @param risorsaScelta 
 * @return true se la risorsa � presente nella categoria
 * @pre	true
 * @post @nochange
 */
...
/**
 * cerca in quale sottocategoria � contenuta la risorsa voluta	
 ...
 */
	 ...
	 * @return risultato il valore dell'id pi� alto presente
	 */
	public int idMax() {
		assert invariante();
