...
public class SistemaTest {
	...
	public void iscrizioneFruitore() {
		...
		Sistema.importaArchivio();
		
		Sistema.iscrizioneFruitore();
		
		assert Sistema.getFruitori().size()==1 || Sistema.getFruitori().size()==0 ;
...
@Test
	public void cercaFruitore() {
		...
		assert Sistema.cercaFruitore("b","b") ;
		
		assert !Sistema.cercaFruitore("a","b") ;
